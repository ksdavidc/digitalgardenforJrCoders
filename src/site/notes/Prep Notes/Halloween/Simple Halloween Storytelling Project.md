...
* New sprite
* Add rectangle 
* Inside rectange, add arrow (triangle): 
...
**THIS IS IT. THIS IS THE MAIN IDEA.**
...
Together, this is the TRANSITION TRICK. Learn it.

### Challenge
Make button to move backwards.
