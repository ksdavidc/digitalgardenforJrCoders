...
- [[Prep Notes/Showcase/Adding Loops and Rearranging Platforms#Adding Loops and Rearranging Platforms|Adding Loops and Rearranging Platforms]]
	- [[Prep Notes/Showcase/Adding Loops and Rearranging Platforms#Adding Loops and Rearranging Platforms|SUMMARY]]
	- [[Prep Notes/Showcase/Adding Loops and Rearranging Platforms#Adding Loops and Rearranging Platforms|DETAILS]]
		- [[Prep Notes/Showcase/Adding Loops and Rearranging Platforms#DETAILS|Set up the Costume Numbers]]
		- [[Prep Notes/Showcase/Adding Loops and Rearranging Platforms#WHERE DO WE CHOOSE THE ORDER OF THE COSTUMES???|Add to the Costume List]]
		- [[Prep Notes/Showcase/Adding Loops and Rearranging Platforms#WHERE DO WE CHOOSE THE ORDER OF THE COSTUMES???|The loop buttons we have changed position]]
		- [[Prep Notes/Showcase/Adding Loops and Rearranging Platforms#WHERE DO WE CHOOSE THE ORDER OF THE COSTUMES???|Copy some code to make the new loop buttons work]]
		- [[Prep Notes/Showcase/Adding Loops and Rearranging Platforms#WHERE DO WE CHOOSE THE ORDER OF THE COSTUMES???|Add dots]]
		- [[Prep Notes/Showcase/Adding Loops and Rearranging Platforms#WHERE DO WE CHOOSE THE ORDER OF THE COSTUMES???|Change the other gravity changers]]
		- [[Prep Notes/Showcase/Adding Loops and Rearranging Platforms#WHERE DO WE CHOOSE THE ORDER OF THE COSTUMES???|Change one of the Goodies (collectibles)]]
		- [[Prep Notes/Showcase/Adding Loops and Rearranging Platforms#WHERE DO WE CHOOSE THE ORDER OF THE COSTUMES???|Change the portal]]
...
- [[Prep Notes/Showcase/Adding Loops and Rearranging Platforms#Adding Loops and Rearranging Platforms|Set up the Costume Numbers]]
...
- [[Prep Notes/Showcase/Adding Loops and Rearranging Platforms#WHERE DO WE CHOOSE THE ORDER OF THE COSTUMES???|The old loop buttons changed position]]
